	...
	Properties
	{
		...
		SubShader
		{
			...
			Pass
			{
				...
				else if (newColour.x > 0.75)
				{
					newColour.x = 1;
				}
				else if (newColour.x > 0.50)
				{
					newColour.x = 0.67;
				}
				else
				...
				else if (newColour.y > 0.75)
				{
					newColour.y = 1;
				}
				else if (newColour.y > 0.50)
				{
					newColour.y = 0.67;
				}
				else
				...
				else if (newColour.z > 0.75)
				{
					newColour.z = 1;
				}
				else if (newColour.z > 0.50)
				{
					newColour.z = 0.67;
				}
				else
